...
function sources_retroarch() {
    gitPullOrClone "$md_build" https://github.com/libretro/RetroArch.git v1.7.8
...
function build_retroarch() {
    local params=(--disable-opengl --disable-opengl1 --disable-sdl --enable-sdl2 --disable-oss --disable-al --disable-jack --disable-qt)
