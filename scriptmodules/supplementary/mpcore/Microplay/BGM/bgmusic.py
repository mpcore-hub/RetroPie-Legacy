...
while True:
	...
	if os.path.exists('/home/pi/Microplay/BGM/DisableMusic'):
		#print "DisableMusic found!"
		if mixer.music.get_busy():
			mixer.music.stop();
		while (os.path.exists('/home/pi/Microplay/BGM/DisableMusic')):
			time.sleep(15)
...
print "An error has occurred that has stopped Background-Music from executing." #theoretically you should never get this far.
